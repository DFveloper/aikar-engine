...
ggml_cgraph * clip_graph_qwen3vl::build() {
    ...
    ggml_tensor * learned_pos_embd = resize_position_embeddings(static_cast<uint32_t>(GGML_SCALE_MODE_BILINEAR) | static_cast<uint32_t>(GGML_SCALE_FLAG_ALIGN_CORNERS));
