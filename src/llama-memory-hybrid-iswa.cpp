...
void llama_memory_hybrid_iswa::set_kv_hadamard_policy(bool k, bool v, bool k_swa, bool v_swa, bool explicit_policy) {
    mem_attn->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
}
