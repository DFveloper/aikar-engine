...
void llama_kv_cache_iswa::set_kv_hadamard_policy(bool k, bool v, bool k_swa, bool v_swa, bool explicit_policy) {
    kv_base->set_kv_hadamard_policy(k, v, k, v, explicit_policy);
