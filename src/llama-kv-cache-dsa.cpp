...
void llama_kv_cache_dsa::set_kv_hadamard_policy(bool k, bool v, bool k_swa, bool v_swa, bool explicit_policy) {
    kv_mla->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
