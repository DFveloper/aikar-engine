...
void llama_kv_cache_dsv4::set_kv_hadamard_policy(bool k, bool v, bool k_swa, bool v_swa, bool explicit_policy) {
    kv_raw->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
    kv_csa->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
    kv_hca->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
    kv_lid->set_kv_hadamard_policy(k, v, k_swa, v_swa, explicit_policy);
}
