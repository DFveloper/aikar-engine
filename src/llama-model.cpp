                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_memory_hybrid_iswa(
                            /* model             */ *this,
                            /* attn_type_k_base  */ params.type_k,
                            /* attn_type_v_base  */ params.type_v,
...
bool llama_model_set_moe_prune(
    ...
    for (size_t i = 0; i < n_layers; ++i) {
        ...
        if ((size_t) n_expert - entry.n_disabled_experts < (size_t) model->hparams.n_expert_used(entry.layer)) {
