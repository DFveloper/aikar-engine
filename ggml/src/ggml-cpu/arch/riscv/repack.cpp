...
void ggml_quantize_mat_q8_0_4x8(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k) {
    ...
    for (int i = 0; i < nb; i++) {
        ...
        vint8m2_t q_r0, q_r1, q_r2, q_r3;
        {
            ...
            float d = ggml_q8_0_scale(x_block_base + 0*k);
            y[i].d[0] = GGML_CPU_FP32_TO_FP16(d);

            float id = d ? 1.0f / d : 0.0f;
            vfloat32m8_t v_scaled = __riscv_vfmul_vf_f32m8(v_src, id, vl_calc);
            v_scaled = __riscv_vfmax_vf_f32m8(v_scaled, -128.0f, vl_calc);
            v_scaled = __riscv_vfmin_vf_f32m8(v_scaled,  127.0f, vl_calc);
...

        {
            ...
            float d = ggml_q8_0_scale(x_block_base + 1*k);
        ...
        asm volatile ("" ::: "memory");
        {
            ...
            float d = ggml_q8_0_scale(x_block_base + 2*k);
        ...
        asm volatile ("" ::: "memory");
        {
            ...
            float d = ggml_q8_0_scale(x_block_base + 3*k);
