...
static inline float32x4_t clamp_q8_0_f32(float32x4_t v) {
    return vmaxq_f32(vdupq_n_f32(-128.0f), vminq_f32(vdupq_n_f32(127.0f), v));
}
#endif
...
void ggml_quantize_mat_q8_0_4x4(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k) {
    ...
    for (int i = 0; i < nb; i++) {
        ...
        for (int j = 0; j < 8; j++) {
            float32x4_t v = clamp_q8_0_f32(vmulq_n_f32(srcv[0][j], id[0]));
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[1][j], id[1]));
            vi = vcvtnq_s32_f32(v);
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[2][j], id[2]));
            vi = vcvtnq_s32_f32(v);
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[3][j], id[3]));
            vi = vcvtnq_s32_f32(v);
...
void ggml_quantize_mat_q8_0_4x8(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k) {
    ...
    for (int i = 0; i < nb; i++) {
        ...
        for (int j = 0; j < 4; j++) {
            float32x4_t v = clamp_q8_0_f32(vmulq_n_f32(srcv[0][2 * j], id[0]));
            int32x4_t vi = vcvtnq_s32_f32(v);
            y[i].qs[32 * j + 0] = vgetq_lane_s32(vi, 0);
            y[i].qs[32 * j + 1] = vgetq_lane_s32(vi, 1);
            y[i].qs[32 * j + 2] = vgetq_lane_s32(vi, 2);
            y[i].qs[32 * j + 3] = vgetq_lane_s32(vi, 3);
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[0][2 * j + 1], id[0]));
            vi = vcvtnq_s32_f32(v);
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[1][2 * j], id[1]));
            vi = vcvtnq_s32_f32(v);
            y[i].qs[32 * j + 8] = vgetq_lane_s32(vi, 0);
            y[i].qs[32 * j + 9] = vgetq_lane_s32(vi, 1);
            y[i].qs[32 * j + 10] = vgetq_lane_s32(vi, 2);
            y[i].qs[32 * j + 11] = vgetq_lane_s32(vi, 3);
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[1][2 * j + 1], id[1]));
            vi = vcvtnq_s32_f32(v);
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[2][2 * j], id[2]));
            vi = vcvtnq_s32_f32(v);
            y[i].qs[32 * j + 16] = vgetq_lane_s32(vi, 0);
            y[i].qs[32 * j + 17] = vgetq_lane_s32(vi, 1);
            y[i].qs[32 * j + 18] = vgetq_lane_s32(vi, 2);
            y[i].qs[32 * j + 19] = vgetq_lane_s32(vi, 3);
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[2][2 * j + 1], id[2]));
            vi = vcvtnq_s32_f32(v);
            ...
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[3][2 * j], id[3]));
            vi = vcvtnq_s32_f32(v);
            y[i].qs[32 * j + 24] = vgetq_lane_s32(vi, 0);
            y[i].qs[32 * j + 25] = vgetq_lane_s32(vi, 1);
            y[i].qs[32 * j + 26] = vgetq_lane_s32(vi, 2);
            y[i].qs[32 * j + 27] = vgetq_lane_s32(vi, 3);
            v = clamp_q8_0_f32(vmulq_n_f32(srcv[3][2 * j + 1], id[3]));
            vi = vcvtnq_s32_f32(v);
