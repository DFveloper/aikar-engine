...
GGML_API void quantize_row_q8_kv_ref(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_q8_kv(const void * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API void ggml_turbo_wht_forward_f32(float * x, int64_t k);
GGML_API void ggml_turbo_wht_inverse_f32(float * x, int64_t k);
...
GGML_API size_t quantize_q8_kv(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
