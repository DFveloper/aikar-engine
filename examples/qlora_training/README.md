...
```text
Q = MXFP4 or Q4_0 model weight
M = Q8_0 QLion momentum
R = Q4_0 error-feedback residual
```
...
| `--chat-template-file` | model metadata | Jinja template file used by every dataset worker |
